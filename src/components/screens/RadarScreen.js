            ...
            <>
              ...
              {state.selectedFlight && !state.isChaseMode && (
                <button
                  ...
                  className="absolute bottom-3 right-3 z-10 min-h-[44px] px-3.5 py-2 bg-cyan/90 hover:bg-cyan active:scale-95 text-black font-mono text-xs font-black rounded-xl shadow-xl flex items-center gap-2 border border-cyan transition-all duration-150 cursor-pointer"
